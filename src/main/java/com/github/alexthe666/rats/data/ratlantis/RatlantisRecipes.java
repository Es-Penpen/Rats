...
public class RatlantisRecipes extends RecipeProvider {
	...
	protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
		...
		this.buildShapedBuildingBlocks(consumer);
		this.buildShapedRedstone(consumer);
		this.buildShapedCombat(consumer);
		this.buildShapedTransportation(consumer);
		this.buildShapedDecorations(consumer);
		this.buildShapedTools(consumer);
		this.buildShapedMisc(consumer);
	...
	private void buildShapedBuildingBlocks(Consumer<FinishedRecipe> consumer){
	...
	private void buildShapedRedstone(Consumer<FinishedRecipe> consumer){
	...
	private void buildShapedTransportation(Consumer<FinishedRecipe> consumer){
	...
	private void buildShapedDecorations(Consumer<FinishedRecipe> consumer){
	...
	private void buildShapedCombat(Consumer<FinishedRecipe> consumer){
	...
	private void buildShapedTools(Consumer<FinishedRecipe> consumer){
	...
	private void buildShapedMisc(Consumer<FinishedRecipe> consumer){
